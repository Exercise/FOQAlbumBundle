            ...
            ->arrayNode('service')
                ...
                ->children()
                    ...
                    ->arrayNode('provider')
                        ->addDefaultsIfNotSet()
                        ->children()
                            ->scalarNode('album')->cannotBeEmpty()->defaultValue('foq_album.provider.album.default')->end()
                            ->scalarNode('photo')->cannotBeEmpty()->defaultValue('foq_album.provider.photo.default')->end()
                        ->end()
                    ->end()
                    ...
                    ->arrayNode('deleter')
                        ->addDefaultsIfNotSet()
                        ->children()
                            ->scalarNode('album')->cannotBeEmpty()->defaultValue('foq_album.deleter.album.default')->end()
                            ->scalarNode('photo')->cannotBeEmpty()->defaultValue('foq_album.deleter.photo.default')->end()
                        ->end()
                    ->end()
                    ->arrayNode('validator')
                        ->addDefaultsIfNotSet()
